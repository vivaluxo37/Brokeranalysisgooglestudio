...
const ShareButtons: React.FC<ShareButtonsProps> = ({ title, url }) => {
  ...
  // Fix: Converted inline SVG JSX to functional components to allow passing props like className.
  // This resolves a TypeScript error with React.cloneElement by rendering the component directly.

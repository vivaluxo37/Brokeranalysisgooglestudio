...
// Export singleton instance - Uncommented for build to work
// Using stub implementation until API keys are configured
class AIProviderManagerStub {
  async generateCompletion() { return ''; }
  async generateStreamCompletion() { return null; }
  async testProviders() { return []; }
}
export const aiProviderManager = new AIProviderManagerStub() as any;

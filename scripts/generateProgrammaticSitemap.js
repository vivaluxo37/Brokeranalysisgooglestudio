...
// Import configurations (these would need to be converted to JS or loaded differently)
...
async function generateProgrammaticSitemap() {
  ...
  try {
    ...
    console.log(`├── SEO category pages: ${stats.seoPages}`);
    console.log(`├── Country pages: ${stats.countries}`);
...
module.exports = { generateProgrammaticSitemap, generateSitemapXML, generateRobotsTxt };
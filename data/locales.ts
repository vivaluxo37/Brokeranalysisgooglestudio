      ...
      education: {
        ...
        quizzes: {
            ...
            orders: {
                ...
                q4: { question: "EUR/USDの現在の価格が1.0750で、1.0800の抵抗線を突破した後に上昇すると信じている場合、どの注文を出しますか？", options: ["1.0800で買い指値", "1.0800で売り逆指値", "1.0800で買い逆指値", "1.0800で売り指値"], correctAnswer: "1.0800で買い逆指値", explanation: "買い逆指値注文は、現在の市場価格より上に置かれます。特定のレベル（ブレイクアウト）に達した後に価格が上昇し続けると信じているときに購入するために使用されます。この場合、上昇の勢いを捉えるために1.0800で買い逆指値注文を出します。" },

      ...
      <div className="bg-gradient-to-r from-green-600 to-teal-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <Icon name="globeAlt" size="lg" className="mx-auto mb-6 text-green-100" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
            <Icon name="buildingOffice2" size="md" className="mx-auto mb-4 text-blue-600" />
          ...
          <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
            <Icon name="globeAlt" size="md" className="mx-auto mb-4 text-green-600" />
          ...
          <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
            <Icon name="userGroup" size="md" className="mx-auto mb-4 text-purple-600" />
